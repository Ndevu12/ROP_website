  ...
  const partnerTypes = [
    {
      ...
      description: "Collaborating with MINEDUC and other government bodies to advance STEM education nationwide.",
    },
    {
      icon: School,
      title: "Educational Institutions",
      description: "Partnering with universities and schools to identify talent and provide training resources.",
    },
    {
      icon: Globe,
      title: "International Organizations",
      description: "Working with global Olympiad committees and educational foundations for knowledge exchange.",
    },
    {
      icon: Heart,
      title: "Private Sector & NGOs",
      description: "Engaging sponsors and non-profits to support student development and competition participation.",
    },
  ]
    ...
    <section id="partners" className="py-24 bg-gray-50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-base font-semibold leading-7 text-[#0891B2]">Partnerships</h2>
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 text-pretty">
            Our success depends on strong partnerships across government, education, and the private sector. Together,
            we're creating opportunities for Rwanda's brightest minds.
          </p>
        </div>
            ...
            <div key={partner.title} className="text-center">
              <div className="flex justify-center mb-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#0891B2]">
                  <partner.icon className="h-8 w-8 text-white" aria-hidden="true" />
                </div>
              </div>
              <h3 className="text-lg font-semibold text-[#0C1E33] mb-2">{partner.title}</h3>
        ...
        <div className="mt-16 bg-gradient-to-r from-[#0891B2] to-[#065F46] rounded-2xl p-12 text-center text-white">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-100">
            Join us in nurturing Rwanda's future innovators. Whether through sponsorship, mentorship, or resource
            sharing, your support makes a lasting impact.
          </p>
